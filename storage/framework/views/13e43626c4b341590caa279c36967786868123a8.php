...
<script>
    ...
    mapboxgl.accessToken = '<?php echo e(env("MAPBOX_KEY")); ?>';
    ...
    map.addSource('route', <?php echo $geoo; ?>);
    map.addLayer({
    'id': 'route',
    'type': 'line',
    'source': 'route',
    ...
    var to = <?php echo $last; ?> //lng, lat
    var from = <?php echo $first; ?>//lng, lat 
...
<?php /**PATH /root/Larave-tracking/resources/views/livewire/rute-location.blade.php ENDPATH**/ ?>